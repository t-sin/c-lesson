...
static void test_initialize_stack() {
    int expected_top = 0;
...
static void test_pop_empty_stack() {
...
static void test_push_one_integer() {
...
static void test_push_one_literal_name() {
...
static void test_pop_one_integer() {
...
static void test_stack_peek_first_element() {
...
static void test_stack_peek_third_element() {
    Element input[4] = {
        {ELEMENT_NUMBER, {1}},
        {ELEMENT_NUMBER, {2}},
        {ELEMENT_NUMBER, {3}},
...
static void test_stack_set_third_element() {
